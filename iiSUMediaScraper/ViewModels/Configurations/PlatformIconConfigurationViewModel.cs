...
/// <summary>
/// Represents the view model for platform icon configuration settings.
/// </summary>
public partial class PlatformIconConfigurationViewModel : ObservablePlatformIconConfiguration
{
    /// <summary>
    ...
    /// </summary>
    [ObservableProperty]
    public PlatformConfigurationViewModel? selectedPlatform;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PlatformIconConfigurationViewModel"/> class.
    /// </summary>
    ...
    public PlatformIconConfigurationViewModel(PlatformIconConfiguration baseModel, ConfigurationViewModel configurationViewModel) : base(baseModel)
    {
    ...
    /// <summary>
    /// Requests removal of the platform icon configuration.
    /// </summary>
    [RelayCommand]
